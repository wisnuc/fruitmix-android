...
public class MediaShareMethodTest {
    ...
    public void getDifferentMediaShareContentInThisMediaShareTest(){
        ...
        mediaShareContent.setDigest("65fac2a5c61906c851727076cc25d2da54d0a908ec492b8307be595f83bb7705");
        mediaShare1.addMediaShareContent(mediaShareContent);

        mediaShareContent = new MediaShareContent();
        mediaShareContent.setDigest("ceeb92546f72b949f629995edeadf64ef5a4cf28aa3db451f3d82ed233e3ea16");
        mediaShare1.addMediaShareContent(mediaShareContent);
        ...
        mediaShareContent = new MediaShareContent();
        mediaShareContent.setDigest("4a12da6e30c4281518ad4551bce953f45a653862e4d1b8849ca73bfc52d19fb9");
        mediaShare2.addMediaShareContent(mediaShareContent);
        ...
        Assert.assertEquals(mediaShareContent.getDigest(),"65fac2a5c61906c851727076cc25d2da54d0a908ec492b8307be595f83bb7705");
        ...
        Assert.assertEquals(mediaShareContent.getDigest(),"4a12da6e30c4281518ad4551bce953f45a653862e4d1b8849ca73bfc52d19fb9");
