...
/*    public static final String DATABASE_REMOTE_GROUP_COMMENT_CREATE = CREATE_TABLE + REMOTE_GROUP_TWEET_TABLE_NAME +
    ...
    public static final String DATABASE_DOWNLOAD_TASK_CREATE = CREATE_TABLE + DOWNLOAD_TASK_TABLE_NAME + BEGIN_SQL
            ...
            + DOWNLOAD_TASK_FILE_REMOTE_UUID + TEXT_NOT_NULL_WITHOUT_COMMA + END_SQL;

    public static final String DATABASE_UPLOAD_TASK_CREATE = CREATE_TABLE + UPLOAD_TASK_TABLE_NAME + BEGIN_SQL
            + ID + INTEGER_PRIMARY_KEY_AUTOINCREMENT + TASK_FIELD_CREATE
            + UPLOAD_TASK_FILE_LOCAL_PATH + TEXT_NOT_NULL_WITHOUT_COMMA + END_SQL;

    //NOTICE:update DB_VERSION when new version occur

    private static final int DB_VERSION = ADD_DOWNLOAD_UPLOAD_TASK_TABLE_VERSION;
