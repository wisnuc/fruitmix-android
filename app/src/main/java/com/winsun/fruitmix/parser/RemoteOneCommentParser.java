    ...
    public UserComment parse(JSONObject jsonObject) {
        ...
        switch (commentType) {
            case "boxmessage":
                ...
                result = new SystemMessageTextComment(uuid, creator, time, "", "", comment);
            ...
            default: {
                ...
                result = new TextComment(uuid, creator, time, "", "", comment);
        ...
        result.setContentJsonStr(jsonObject.toString());

        return result;
    }

    @NonNull
    private TextComment analyzeCommentContainsList(JSONObject jsonObject, String uuid, long time, long index, String comment, User creator) {
