...
public interface TorrentDataSource {

    void getAllTorrentDownloadInfo(BaseLoadDataCallback<TorrentDownloadInfo> callback);

    void postTorrentDownloadTask(String dirUUID, File torrent, BaseOperateDataCallback<TorrentRequestParam> callback);

    void postTorrentDownloadTask(String dirUUID, String magnetUrl, BaseOperateDataCallback<TorrentRequestParam> callback);
