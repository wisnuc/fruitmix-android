...
interface FileDataSource {
    ...
    fun moveFile(srcFolder: AbstractRemoteFile, targetFolder: AbstractRemoteFile, entries: List<AbstractRemoteFile>,
                 callback: BaseOperateDataCallback<Task>)

    fun copyFile(srcFolder: AbstractRemoteFile, targetFolder: AbstractRemoteFile, entries: List<AbstractRemoteFile>,
                 callback: BaseOperateDataCallback<Task>)
