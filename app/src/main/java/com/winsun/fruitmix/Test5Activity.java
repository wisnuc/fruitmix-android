...
public class Test5Activity extends Activity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        scrollGalleryView
                ...
                .addMedia(MediaInfo.mediaLoader(new DefaultImageLoader(R.drawable.yesshou)))
                .addMedia(MediaInfo.mediaLoader(new DefaultImageLoader(toBitmap(R.drawable.yesshou))))
                .addMedia(MediaInfo.mediaLoader(new MediaLoader() {
                    ...
                    @Override public void loadMedia(Context context, ImageView imageView,
                        ...
                        imageView.setImageBitmap(toBitmap(R.drawable.yesshou));
                        callback.onSuccess();
                    }

                    @Override public void loadThumbnail(Context context, ImageView thumbnailView,
                                                        MediaLoader.SuccessCallback callback) {
                        thumbnailView.setImageBitmap(toBitmap(R.drawable.yesshou));
                        callback.onSuccess();
                    }
                }))
