...
public class ScrollbarPanelListView extends ListView implements OnScrollListener {
    ...
    public ScrollbarPanelListView(Context context, AttributeSet attrs, int defStyle) {
        super(new ContextThemeWrapper(context, R.style.FastScrollTheme), attrs, defStyle);
        ...
        final int scrollBarPanelInAnimation = a.getResourceId(R.styleable.ScrollbarPanelListView_scrollBarPanelInAnimation, R.anim.scrollbarpanel_in_animation);
        final int scrollBarPanelOutAnimation = a.getResourceId(R.styleable.ScrollbarPanelListView_scrollBarPanelOutAnimation, R.anim.scrollbarpanel_out_animation);
        a.recycle();
