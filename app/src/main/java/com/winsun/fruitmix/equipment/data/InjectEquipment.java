...
public class InjectEquipment {
    ...
    public static EquipmentDataSource provideEquipmentDataSource(Context context) {
        ...
        return new EquipmentDataRepository(ThreadManagerImpl.getInstance(),new EquipmentRemoteDataSource(InjectHttp.provideIHttpUtil(context), InjectHttp.provideHttpRequestFactory()));
